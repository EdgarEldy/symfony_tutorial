 ...
 */
final class Version20200812213245 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, customer_id_id INT NOT NULL, product_id_id INT NOT NULL, qty VARCHAR(255) NOT NULL, total VARCHAR(255) NOT NULL, INDEX IDX_F5299398B171EB6C (customer_id_id), INDEX IDX_F5299398DE18E50B (product_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
